  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
        ...
        {/* Right Column: Floating Labels — Styled as an IDE Code/Canvas Viewer */}
        <div className="lg:col-span-5 relative w-full rounded-2xl border border-border-warm bg-soft-panel/40 backdrop-blur-md overflow-hidden shadow-2xl flex flex-col h-[380px] md:h-[450px]">
          {/* macOS window header */}
          <div className="flex items-center justify-between px-4 py-2.5 border-b border-border-warm/60 bg-elevated-panel/30 select-none shrink-0">
            ...
            {/* Active File Tab */}
            <div className="flex items-center gap-1.5 text-[10px] sm:text-xs text-text-secondary font-mono bg-main-bg/50 px-3 py-1 rounded border border-border-warm/30 -mb-2.5 mt-[-4px] relative z-10 border-b-transparent">
              <span className="w-2 h-2 rounded bg-accent-cool/20 text-accent-cool inline-flex items-center justify-center font-bold text-[8px] select-none">TSX</span>
              <span>Canvas.tsx</span>
            </div>
            
            <div className="text-[10px] text-text-muted font-mono uppercase tracking-widest hidden sm:inline">
              interactive
            </div>
          </div>
          ...
          <div className="relative flex-1 w-full overflow-hidden select-none">
            ...
            <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-accent-main/[0.02] via-transparent to-transparent pointer-events-none z-10 select-none" />
            ...
            <div className="absolute bottom-4 left-4 flex items-center gap-1.5 px-2.5 py-1 rounded bg-main-bg/85 border border-border-warm text-[10px] text-text-muted font-mono pointer-events-none">
              <span className="w-1.5 h-1.5 rounded-full bg-accent-main animate-pulse" />
              <span>Click project / Drag to interact</span>
            </div>
          </div>
        </div>
